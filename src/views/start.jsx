    ...
    <Background src={image}>
      <Container style={{ display: 'flex', justifyContent: 'space-between' }}>
        <div style={style.main}>
          ...
          <p style={style.text}>CONHECENDO AS COMUNIDADES E</p>
          <p style={style.text}>OS POVOS TRADICIONAIS</p>

          <NavButton
            url="/boas-vindas"
            label="COMEÇAR"
            style={{ marginBottom: 50, width: 300, marginTop: 66, background: '#FF9955', color: '#FFF' }}
          />
        </div>
